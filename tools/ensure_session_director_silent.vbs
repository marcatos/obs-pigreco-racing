' Silent launcher for tools/ensure_session_director.py (no console window).
' Used by OBS Lua autostart (pigreco_config_autostart.lua).
Option Explicit
...
ensure = root & "\tools\ensure_session_director.py"
